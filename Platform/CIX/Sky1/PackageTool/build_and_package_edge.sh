...
build -a AARCH64 -t GCC5 -p $UEFI_DSC_FILE -b $UEFI_TARGET -D BOARD_NAME=$BOARD -D BUILD_DATE=$BUILD_DATE -D COMMIT_HASH=$COMMIT_HASH -D SMP_ENABLE=1 -D FASTBOOT_LOAD=nvme -D VARIABLE_TYPE=EMU -D STANDARD_MM=FALSE  -D SYSTEM_LOADER=android 
